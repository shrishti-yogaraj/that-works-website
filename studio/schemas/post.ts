...
export const post = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: "string",
      group: "content",
      description: "Emoji or short symbol shown on article cards. E.g. 🧭 📊 ⚡",
    }),
    defineField({
      name: "accentColor",
      title: "Accent Colour",
      type: "string",
      group: "content",
      description: "Controls the card header gradient/colour on the hub. Leave blank to use category default.",
      options: {
        list: [
    ...
    defineField({
      ...
      type: "array",
      group: "taxonomy",
      description: "Primary search terms this post should rank for. Separate from tags — used for internal search and Cleo AI context.",
      of: [{ type: "string" }],
      options: { layout: "tags" },
    }),
    defineField({
