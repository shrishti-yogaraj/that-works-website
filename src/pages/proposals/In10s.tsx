      ...
      <section className="buckets-overview" id="engagement">
        <div className="section-inner fade-in">
          ...
          <ul className="buckets-list">
            <li className="buckets-list-item outbound"><span className="bl-outbound">Outbound Only</span><span className="bl-num">01</span><span className="bl-phase">Wks 1–4</span><span className="bl-title">ICP, Data &amp; CRM Foundation</span><span className="bl-line">Documented ICP per product line and persona, verified 300–600 account target list, VTiger restructured, GA4 + GSC set up, DPDP-compliant from day one.</span></li>
            <li className="buckets-list-item outbound"><span className="bl-outbound">Outbound Only</span><span className="bl-num">02</span><span className="bl-phase">Wks 1–7</span><span className="bl-title">Three-Tier Outbound &amp; Nurture</span><span className="bl-line">Cold mass, intent-triggered, and database reactivation sequences, three motions on one infrastructure, with domain warmup and automated reply handling.</span></li>
      ...
      <section className="kpi-section" id="kpis">
        <div className="kpi-inner fade-in">
          ...
          <div className="kpi-grid">
            <div className="kpi-card"><div className="kpi-card-header"><div className="kpi-channel">Outbound Engine</div><div className="kpi-channel-tag">Bucket 02</div></div><ul className="kpi-list"><li className="kpi-item"><div className="kpi-metric">Domain reputation post-warmup</div><div className="kpi-target">95%+ healthy</div></li><li className="kpi-item"><div className="kpi-metric">Cold sequence reply rate (Tier 1)</div><div className="kpi-target">2–4%</div></li><li className="kpi-item"><div className="kpi-metric">Intent-triggered reply rate (Tier 2)</div><div className="kpi-target">12–15%</div></li><li className="kpi-item"><div className="kpi-metric">Qualified replies surfaced as hot leads</div><div className="kpi-target">15+ per month</div></li></ul></div>
            <div className="kpi-card"><div className="kpi-card-header"><div className="kpi-channel">Inbound &amp; Scoring</div><div className="kpi-channel-tag">Bucket 03</div></div><ul className="kpi-list"><li className="kpi-item"><div className="kpi-metric">Time from form fill to enriched profile</div><div className="kpi-target">&lt; 5 minutes</div></li><li className="kpi-item"><div className="kpi-metric">Hot lead alert SLA compliance</div><div className="kpi-target">90%+ within 2 hrs</div></li><li className="kpi-item"><div className="kpi-metric">MQL → first call conversion</div><div className="kpi-target">25–35% (from 7%)</div></li><li className="kpi-item"><div className="kpi-metric">Visitor de-anonymisation rate</div><div className="kpi-target">25–30% of ICP traffic</div></li></ul></div>
            <div className="kpi-card"><div className="kpi-card-header"><div className="kpi-channel">LinkedIn Engine</div><div className="kpi-channel-tag">Bucket 04</div></div><ul className="kpi-list"><li className="kpi-item"><div className="kpi-metric">Posts published vs. plan</div><div className="kpi-target">100% (30+ posts)</div></li><li className="kpi-item"><div className="kpi-metric">Executive page activated &amp; posting</div><div className="kpi-target">Yes · 4–6 drafts live</div></li><li className="kpi-item"><div className="kpi-metric">ICP-account engagement events captured</div><div className="kpi-target">All routed to scoring</div></li><li className="kpi-item"><div className="kpi-metric">Sales Navigator connection acceptance</div><div className="kpi-target">30%+ ICP rate</div></li></ul></div>
            <div className="kpi-card"><div className="kpi-card-header"><div className="kpi-channel">Database &amp; Newsletter</div><div className="kpi-channel-tag">Bucket 05</div></div><ul className="kpi-list"><li className="kpi-item"><div className="kpi-metric">Dormant contact reactivation reply rate</div><div className="kpi-target">15–20%</div></li><li className="kpi-item"><div className="kpi-metric">Newsletter open rate (post-restructure)</div><div className="kpi-target">30%+ baseline</div></li><li className="kpi-item"><div className="kpi-metric">Newsletter engagement → score events</div><div className="kpi-target">All tracked &amp; routed</div></li><li className="kpi-item"><div className="kpi-metric">Database segments built &amp; tagged</div><div className="kpi-target">5+ usable segments</div></li></ul></div>
            <div className="kpi-card"><div className="kpi-card-header"><div className="kpi-channel">Reporting &amp; Attribution</div><div className="kpi-channel-tag">Bucket 06</div></div><ul className="kpi-list"><li className="kpi-item"><div className="kpi-metric">Unified dashboard live &amp; auto-updating</div><div className="kpi-target">Yes · Week 8</div></li><li className="kpi-item"><div className="kpi-metric">Multi-touch attribution coverage</div><div className="kpi-target">100% of channels</div></li><li className="kpi-item"><div className="kpi-metric">Closed-loop reporting on MQLs</div><div className="kpi-target">Live by Week 9</div></li><li className="kpi-item"><div className="kpi-metric">SOPs covering every workflow</div><div className="kpi-target">100% documented</div></li></ul></div>
            <div className="kpi-card"><div className="kpi-card-header"><div className="kpi-channel">Pipeline-Level</div><div className="kpi-channel-tag">End-to-End</div></div><ul className="kpi-list"><li className="kpi-item"><div className="kpi-metric">New qualified opportunities surfaced</div><div className="kpi-target">25–40 by Week 10</div></li><li className="kpi-item"><div className="kpi-metric">Sales-marketing SLA framework live</div><div className="kpi-target">Yes · Week 4</div></li><li className="kpi-item"><div className="kpi-metric">Mohanty operating system independently</div><div className="kpi-target">By Week 10 handover</div></li><li className="kpi-item"><div className="kpi-metric">2-week post-handover check-in completed</div><div className="kpi-target">Yes · Week 12</div></li></ul></div>
          </div>
          </div></div>
        </div>
      </section>
