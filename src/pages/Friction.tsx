...
const tiers = [
  ...
  },
  {
    ...
    deliverables: [
      <><Link to="/services/branding">Complete brand rebuild</Link></>,
      <><Link to="/services/inbound">Full inbound overhaul</Link></>,
      <><Link to="/services/lead-gen">Outbound rebuild</Link> with CRM automation and lead scoring</>,
